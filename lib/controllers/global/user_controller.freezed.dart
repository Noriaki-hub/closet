...
class _$UserStateTearOff {
  ...
  _UserState call(
      {UserModel user = const UserModel(uid: ''),
...
abstract class $UserStateCopyWith<$Res> {
  ...
  $Res call({UserModel user, bool isFirstLogin, bool isCurrentState});
    ...
    return _then(_value.copyWith(
      user: user == freezed
          ...
          : user // ignore: cast_nullable_to_non_nullable
              as UserModel,
      isFirstLogin: isFirstLogin == freezed
          ? _value.isFirstLogin
...
class _$_UserState implements _UserState {
  ...
  @override
  String toString() {
    return 'UserState(user: $user, isFirstLogin: $isFirstLogin, isCurrentState: $isCurrentState)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.isFirstLogin, isFirstLogin) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(isFirstLogin),
...
abstract class _UserState implements UserState {
  const factory _UserState(
      {UserModel user, bool isFirstLogin, bool isCurrentState}) = _$_UserState;
