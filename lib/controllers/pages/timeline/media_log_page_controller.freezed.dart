...
class _$_MediaLogPageState extends _MediaLogPageState {
  ...
  @override
  String toString() {
    return 'MediaLogPageState(logMap: $logMap, isLoading: $isLoading, logList: $logList, isScrollLoading: $isScrollLoading, lastItemId: $lastItemId, isAddClothes: $isAddClothes)';
  }
