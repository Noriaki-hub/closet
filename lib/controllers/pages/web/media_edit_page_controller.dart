...
final mediaEditPageProvider = StateNotifierProvider.autoDispose<
    MediaEditPageController, MediaEditPageState>((ref) {
...
class MediaEditPageController extends StateNotifier<MediaEditPageState> {
  ...
  Future<void> updateMedia({required Media media}) async {
    ...
    await _read(mediaRepositoryProvider)
        .update(userId: user.uid, media: _media);
  }
}
