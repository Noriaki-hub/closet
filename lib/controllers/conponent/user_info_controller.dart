...
import '../../repositories/conponent/user_info_repository.dart';
...
StateNotifierProvider.autoDispose<UserInfoController, UserInfoState>(
        (ref) {
      return throw UnimplementedError();
    });

final UserInfoProviderFamily = StateNotifierProvider.family.autoDispose<
    UserInfoController,
    UserInfoState,
    UserInfoProviderArg>((ref, arg) {
