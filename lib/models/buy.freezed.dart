...
class _$BuyTearOff {
  ...
  Buy fromJson(Map<String, Object?> json) {
    return Buy.fromJson(json);
  }
}

/// @nodoc
const $Buy = _$BuyTearOff();
...
/// @nodoc
abstract class _$BuyCopyWith<$Res> implements $BuyCopyWith<$Res> {
...
/// @nodoc
class __$BuyCopyWithImpl<$Res> extends _$BuyCopyWithImpl<$Res>
...
/// @nodoc
@JsonSerializable()
class _$_Buy extends _Buy with DiagnosticableTreeMixin {
  const _$_Buy(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'Buy'))
...
abstract class _Buy extends Buy {
  const factory _Buy(
      {@FireTimestampConverterNonNull() required DateTime createdBuy,
      @FireTimestampConverterNonNull() DateTime? createdSell,
      String itemId,
      ...
      String uid,
      String buyingForm,
      int likedCount}) = _$_Buy;
  const _Buy._() : super._();
